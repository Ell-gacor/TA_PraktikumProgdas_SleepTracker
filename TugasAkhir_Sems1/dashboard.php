                ...
                ?>
                    ...
                    case "notes":
                        ...
                        if (empty($tracker->notes)) {
                            ...
                            // Reverse array to show newest first
                            $reversedNotes = array_reverse($tracker->notes);
                            $reversedStack = array_reverse($tracker->stack);
                            foreach ($reversedNotes as $i => $note) {
                                $date = $reversedStack[$i]['date'] ?? date('Y-m-d');
                                $duration = $reversedStack[$i]['duration'] ?? 0;
                                echo "
                                <div class='note-card'>
